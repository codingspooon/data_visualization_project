                ...
                box(
                  ...
                  column(12, 
                         ...
                         fluidRow(column(12,"What Netflix Movie Engine can do are:" ,br(),
                                         ...
                                         tags$li("Visualize other trends, such as the change in the total number of movies released each year from 1953 to 2022, the runtime of movies, IMDB ratings or votes."),
